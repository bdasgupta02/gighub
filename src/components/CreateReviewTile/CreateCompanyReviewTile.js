...
const CreateCompanyReviewTile = (props) => {
    ...
    const handleSubmit = useCallback(async event => {
        ...
        if (textReview === null || numStars === 0) {
            ...
            try {
                ...
                await fbFunctions.createWorkerReview(review, workerId)
                //REDIRECT
                setSubmitError("Successfully reviewed worker!")
                setLoading(false)
            } catch (e) {
...
export default CreateCompanyReviewTile
